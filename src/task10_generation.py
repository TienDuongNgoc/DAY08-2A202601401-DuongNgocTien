...
LLM_MODEL = "inclusionai/ling-3.0-flash:free"  # hoặc model ":free" nếu chưa có credit
...
def generate_with_citation(query: str, top_k: int = TOP_K) -> dict:
    ...
    if api_key:
        ...
        answer = "[Warning] No OPENROUTER_API_KEY or OPENAI_API_KEY found in environment variables. Please set it to generate response."
